	...
	return (
		<div className='page'>
			<div className='story-container'>
				...
				{story.video ? (
					<div>
						<h3 className='video-title'>{story.videoTitle || ''}</h3>
						<a
							className='video-preview-history'
							href={story.video}
							target='_blank'
							rel='noopener noreferrer'
						>
							<div className='play-icon-history'>&#9658;</div>
						</a>
					</div>
				) : (
					<Image
				...
				<div className='story-meta'>
					{story.icon && (
						<img className='author-icon' src={story.icon} alt='author' />
					)}
					...
					<div className='quote'>
						...
						<blockquote className='story-quote'>
							{story.quote.map((p, idx) => (
								<p className='story-quote' key={idx}>
									{p}
								</p>
							))}
						</blockquote>
